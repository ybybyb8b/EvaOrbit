...
export type ReminderProjectionOwner = "reminder" | "cat_routine" | "tracker" | "medication_preset" | "meal_rule" | "weight_settings" | "unknown";
...
export function reminderSourceLabel(sourceType: string | null | undefined, targetType?: string) {
  ...
  if (targetType === "health") return "Health";
